...
const DOMAIN = process.env.MAIL_FROM;
...
exports.registerController = (req, res) => {
  ...
  if (!errors.isEmpty()) {
    ...
    const emailData = {
      ...
      to: email,
      subject: 'Neurocare Account activation link',
      html: `
                <h1>Create your Neurocare Account</h1>
    ...
    User.findOne(
      ...
      (err, user) => {
        ...
        const emailData = {
          from: process.env.EMAIL_FROM,
          to: email,
          subject: `Neurocare Password recovery`,
          html: `
